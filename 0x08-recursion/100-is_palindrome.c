 ...
 * @s: It represents the string to reverse
 *
 ...
 * @s: It represents the string to calculate the length of
 *
 ...
 * @s: It represents the string to check
 * @i: It represents iterator
 * @len: It represents the length of the string
 *
